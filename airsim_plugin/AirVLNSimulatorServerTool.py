...
env_exec_path_dict = {
    ...
    "BrushifyUrban_test": {
        ...
        'exec_path': 'TEST_ENVS/BrushifyUrban',  # <- 这里加上 TEST_ENVS/
    },
    "CabinLake_test": {
        'bash_name': 'CabinLake',
        'exec_path': 'TEST_ENVS/CabinLake',  # <- 这里加上 TEST_ENVS/
    },
    "BrushifyUrban_TrainSets": {
        'bash_name': 'BrushifyUrban',
        'exec_path': 'TRAIN_ENVS/BrushifyUrban',
    },
    "CabinLake_TrainSets": {
        'bash_name': 'CabinLake',
        'exec_path': 'TRAIN_ENVS/CabinLake',
    },
    "CityPark_test": {
        'bash_name': 'CityPark',
        'exec_path': 'CityPark',
